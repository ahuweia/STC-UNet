...
def main():
    ...
    cfg = mmcv.Config.fromfile(os.path.join(args.work_dirs, args.config, args.config + '.py'))
    ...
    checkpoint = load_checkpoint(model, os.path.join(args.work_dirs, args.config, args.checkpoint), map_location='cpu')
